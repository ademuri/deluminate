import { api, getSiteSettings, getEnabled, resetSiteSchemes } from '../common.js';
...
describe('Import functionality', () => {
  ...
  beforeEach(async () => {
    const optionsHtml = fs.readFileSync(new URL('../options.html', import.meta.url), 'utf-8');
  ...
  it('imports V2 settings correctly', async function () {
    const v2Data = {
      version: 2,
      enabled: false,
      sites: [['test.com', 'dim1', 'kill_background']],
    };
