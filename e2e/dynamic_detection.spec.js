...
test.describe('Dynamic Dark Site Detection', () => {
  test('should NOT detect a light site as dark even if it mentions prefers-color-scheme', async ({
    page,
    context,
    server,
    extensionId,
  ...
  test('should detect a truly dark site as dark', async ({
    page,
    context,
    server,
    extensionId,
  ...
  test('should react to dynamic DOM changes that make the page dark', async ({
    page,
    context,
    server,
    extensionId,
